...
public abstract class StateAction : IStateComponent
{
    ...
    ///     The StateAction in this case would have to implement all the relative functions, and use an if statement with this
    ///     enum as a condition to decide whether to act or not in each moment.
    /// </summary>
    ...
    /// <summary>
    ///     Use this property to access shared data from the <see cref="StateActionSO" /> that corresponds to this
    ///     <see cref="StateAction" />
    /// </summary>
    ...
    /// <summary>
    ///     Called every frame the <see cref="StateMachine" /> is in a <see cref="State" /> with this
    ///     <see cref="StateAction" />.
    /// </summary>
